...
# Varying kernel size for both noise types

# Apply Box Filter with 5x5 and 10x10 kernels
box_filtered_gaussian_5x5 = box_filter(noise_std_50_image, kernel_size=5)
box_filtered_gaussian_10x10 = box_filter(noise_std_50_image, kernel_size=10)
box_filtered_sp_5x5 = box_filter(sp_noise_30_image, kernel_size=5)
box_filtered_sp_10x10 = box_filter(sp_noise_30_image, kernel_size=10)

# Apply Median Filter with 5x5 and 10x10 kernels
median_filtered_gaussian_5x5 = median_filter(noise_std_50_image, kernel_size=5)
median_filtered_gaussian_10x10 = median_filter(noise_std_50_image, kernel_size=10)
median_filtered_sp_5x5 = median_filter(sp_noise_30_image, kernel_size=5)
median_filtered_sp_10x10 = median_filter(sp_noise_30_image, kernel_size=10)

# Apply Gaussian Filter with 5x5 and 10x10 kernels
gaussian_filtered_gaussian_5x5 = gaussian_filter(noise_std_50_image, kernel_size=5, sigma=1)
gaussian_filtered_gaussian_10x10 = gaussian_filter(noise_std_50_image, kernel_size=10, sigma=1)
gaussian_filtered_sp_5x5 = gaussian_filter(sp_noise_30_image, kernel_size=5, sigma=1)
gaussian_filtered_sp_10x10 = gaussian_filter(sp_noise_30_image, kernel_size=10, sigma=1)

# Save the filtered images with different kernel sizes

# For Gaussian noise
cv2.imwrite('box_filtered_gaussian_5x5.png', box_filtered_gaussian_5x5)
cv2.imwrite('box_filtered_gaussian_10x10.png', box_filtered_gaussian_10x10)
cv2.imwrite('median_filtered_gaussian_5x5.png', median_filtered_gaussian_5x5)
cv2.imwrite('median_filtered_gaussian_10x10.png', median_filtered_gaussian_10x10)
cv2.imwrite('gaussian_filtered_gaussian_5x5.png', gaussian_filtered_gaussian_5x5)
cv2.imwrite('gaussian_filtered_gaussian_10x10.png', gaussian_filtered_gaussian_10x10)

# For Salt and Pepper noise
cv2.imwrite('box_filtered_sp_5x5.png', box_filtered_sp_5x5)
cv2.imwrite('box_filtered_sp_10x10.png', box_filtered_sp_10x10)
cv2.imwrite('median_filtered_sp_5x5.png', median_filtered_sp_5x5)
cv2.imwrite('median_filtered_sp_10x10.png', median_filtered_sp_10x10)
cv2.imwrite('gaussian_filtered_sp_5x5.png', gaussian_filtered_sp_5x5)
cv2.imwrite('gaussian_filtered_sp_10x10.png', gaussian_filtered_sp_10x10)
